 ...
 * @generated
 */
public class VmPlacementSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VmPlacementPackage.SYSTEM: {
				VmPlacement.System system = (VmPlacement.System)theEObject;
	 ...
	 * @generated
	 */
	public T caseSystem(VmPlacement.System object) {
		return null;
	}
