...
class Test(unittest.TestCase):
    ...
    def testName(self):
        ...
        solver.add_soft(memVm(vmI[1])==2, 50)
        solver.add_soft(memVm(vmI[2])==4, 50)
        ...
        rp = ResultPainter()
        rp.vars = algoI + encI + vmI + storI
        rp.refs = [dAlgoEnc, dAlgoVm, dEncVm, dStorVm, dAlgoStor]
        rp.types = [toAlgo, toEnc, toVm, toStor]
        rp.filters = [useAlgo, useEnc, useVm, useStor]
