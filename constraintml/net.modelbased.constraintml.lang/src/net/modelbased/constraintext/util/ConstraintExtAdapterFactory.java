 ...
 * @generated
 */
public class ConstraintExtAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public ConstraintExtAdapterFactory() {
	 ...
	 * @generated
	 */
	protected ConstraintExtSwitch<Adapter> modelSwitch =
		new ConstraintExtSwitch<Adapter>() {
			@Override
			public Adapter caseConfigAnno(ConfigAnno object) {
				return createConfigAnnoAdapter();
			}
			@Override
			public Adapter caseExpDetail(ExpDetail object) {
				return createExpDetailAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.modelbased.constraintext.ConfigAnno <em>Config Anno</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createConfigAnnoAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link net.modelbased.constraintext.ExpDetail <em>Exp Detail</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createExpDetailAdapter() {
		return null;
	}
